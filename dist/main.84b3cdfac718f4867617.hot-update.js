...
.khEydDmLEatVrC9m6vaX:hover .UnZ6KR_jZD9STnsi3sb2 {
  opacity: 1;
}`, "",{"version":3,"sources":["webpack://./src/renderer/components/Interface/ImagePicker/ImagePicker.module.css"],"names":[],"mappings":"AAAA;EACE,kBAAkB;EAClB,YAAY;EACZ,WAAW;EACX,kBAAkB;EAClB,gBAAgB;EAChB,eAAe;EACf,+BAA+B;AACjC;;AAEA;EACE,WAAW;EACX,YAAY;EACZ,iBAAiB;EACjB,cAAc;AAChB;;AAEA;EACE,kBAAkB;EAClB,MAAM;EACN,QAAQ;EACR,SAAS;EACT,OAAO;EACP,UAAU;EACV,UAAU;EACV,6BAA6B;AAC/B;;AAEA;EACE,UAAU;AACZ","sourcesContent":[".imagePreview {\n  position: relative;\n  height: 36px;\n  width: 36px;\n  border-radius: 6px;\n  overflow: hidden;\n  cursor: pointer;\n  border: 1px solid var(--border);\n}\n\n.imagePreview img {\n  width: 100%;\n  height: 100%;\n  object-fit: cover;\n  display: block;\n}\n\n.removeButton {\n  position: absolute;\n  top: 0;\n  right: 0;\n  bottom: 0;\n  left: 0;\n  opacity: 0;\n  color: red;\n  transition: opacity 0.2s ease;\n}\n\n.imagePreview:hover .removeButton {\n  opacity: 1;\n}"],"sourceRoot":""}]);
// Exports
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("4744d5d8478ef6478571")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.84b3cdfac718f4867617.hot-update.js.map