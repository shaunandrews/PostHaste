...
`, "",{"version":3,"sources":["webpack://./src/renderer/components/Interface/ImagePicker/ImagePicker.module.css"],"names":[],"mappings":"AAAA;EACE,kBAAkB;EAClB,YAAY;EACZ,WAAW;EACX,kBAAkB;EAClB,sBAAsB;EACtB,eAAe;EACf,+BAA+B;AACjC;;AAEA;EACE,WAAW;EACX,YAAY;EACZ,cAAc;AAChB;;AAEA;EACE,kBAAkB;EAClB,MAAM;EACN,QAAQ;EACR,SAAS;EACT,OAAO;EACP,8BAA8B;EAC9B,YAAY;EACZ,aAAa;EACb,mBAAmB;EACnB,uBAAuB;EACvB,eAAe;EACf,UAAU;EACV,6BAA6B;EAC7B,YAAY;AACd;;AAEA;EACE,8BAA8B;AAChC;;AAEA;EACE,UAAU;AACZ","sourcesContent":[".imagePreview {\n  position: relative;\n  height: 36px;\n  width: 40px;\n  border-radius: 6px;\n  /* overflow: hidden; */\n  cursor: pointer;\n  border: 1px solid var(--border);\n}\n\n.imagePreview img {\n  width: 100%;\n  height: auto;\n  display: block;\n}\n\n.removeButton {\n  position: absolute;\n  top: 0;\n  right: 0;\n  bottom: 0;\n  left: 0;\n  background: rgba(0, 0, 0, 0.6);\n  border: none;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  cursor: pointer;\n  opacity: 0;\n  transition: opacity 0.2s ease;\n  color: white;\n}\n\n.removeButton:hover {\n  background: rgba(0, 0, 0, 0.8);\n}\n\n.imagePreview:hover .removeButton {\n  opacity: 1;\n}\n"],"sourceRoot":""}]);
// Exports
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("c6d6dd4c37bed0a56644")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.39b6793def9618f536d0.hot-update.js.map