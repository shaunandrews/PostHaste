...
.kTUSyQMV8G9BoRm7nqlg img {
  ...
  height: 100%;
  object-fit: cover;
}`, "",{"version":3,"sources":["webpack://./src/renderer/components/Editor/Editor.module.css"],"names":[],"mappings":"AAAA;EACE,aAAa;EACb,QAAQ;EACR,sBAAsB;EACtB,YAAY;EACZ,aAAa;EACb,eAAe;EACf,aAAa;AACf;;AAEA;EACE,YAAY;EACZ,aAAa;EACb,sBAAsB;EACtB,cAAc;EACd,SAAS;EACT,WAAW;EACX,uBAAuB;AACzB;;AAEA;EACE,oCAAoC;EACpC,eAAe;EACf,YAAY;EACZ,kCAAkC;EAClC,aAAa;EACb,mBAAmB;AACrB;;AAEA;EACE,+BAA+B;AACjC;;AAEA;EACE,YAAY;EACZ,aAAa;AACf;;AAEA;EACE,+BAA+B;EAC/B,oBAAoB;AACtB;;AAEA;EACE,YAAY;AACd;;AAEA;EACE,aAAa;EACb,yBAAyB;EACzB,mBAAmB;EACnB,kBAAkB;EAClB,eAAe;EACf,SAAS;EACT,gBAAgB;EAChB,SAAS;AACX;;AAEA;EACE,aAAa;EACb,8BAA8B;EAC9B,mBAAmB;AACrB;;AAEA;;EAEE,aAAa;EACb,mBAAmB;EACnB,SAAS;AACX;;AAEA;EACE,WAAW;EACX,YAAY;EACZ,kBAAkB;EAClB,gBAAgB;EAChB,eAAe;EACf,+BAA+B;EAC/B,6BAA6B;AAC/B;;AAEA;EACE,YAAY;AACd;;AAEA;EACE,WAAW;EACX,YAAY;EACZ,iBAAiB;AACnB","sourcesContent":[".container {\n  display: flex;\n  gap: 6px;\n  flex-direction: column;\n  flex-grow: 1;\n  height: 100vh;\n  background: red;\n  padding: 12px;\n}\n\n.editor {\n  flex-grow: 1;\n  display: flex;\n  flex-direction: column;\n  overflow: auto;\n  gap: 10px;\n  width: 100%;\n  /* background: green; */\n}\n\n.title {\n  font-weight: var(--font-weight-bold);\n  font-size: 12px;\n  padding: 6px;\n  background: var(--background-tint);\n  display: flex;\n  align-items: center;\n}\n\n.title:empty:before {\n  content: attr(data-placeholder);\n}\n\n.canvas {\n  flex-grow: 1;\n  outline: none;\n}\n\n.canvas:empty:before {\n  content: attr(data-placeholder);\n  pointer-events: none;\n}\n\n.canvas:empty:focus:before {\n  opacity: 0.5;\n}\n\n.tools {\n  display: flex;\n  justify-content: flex-end;\n  align-items: center;\n  padding: 12px 24px;\n  font-size: 14px;\n  gap: 12px;\n  position: sticky;\n  bottom: 0;\n}\n\n.actions {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n}\n\n.leftActions,\n.rightActions {\n  display: flex;\n  align-items: center;\n  gap: 12px;\n}\n\n.imagePreview {\n  width: 40px;\n  height: 40px;\n  border-radius: 4px;\n  overflow: hidden;\n  cursor: pointer;\n  border: 1px solid var(--border);\n  transition: opacity 0.2s ease;\n}\n\n.imagePreview:hover {\n  opacity: 0.8;\n}\n\n.imagePreview img {\n  width: 100%;\n  height: 100%;\n  object-fit: cover;\n}"],"sourceRoot":""}]);
// Exports
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("60417fae2a66a25de1ed")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.3598366fd002a787f9b4.hot-update.js.map