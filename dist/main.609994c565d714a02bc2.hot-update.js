...
`, "",{"version":3,"sources":["webpack://./src/renderer/components/Interface/ImagePicker/ImagePicker.module.css"],"names":[],"mappings":"AAAA;EACE,kBAAkB;EAClB,YAAY;EACZ,WAAW;EACX,kBAAkB;EAClB,gBAAgB;EAChB,eAAe;EACf,+BAA+B;AACjC;;AAEA;EACE,WAAW;EACX,YAAY;EACZ,iBAAiB;EACjB,cAAc;AAChB;;AAEA;EACE,kBAAkB;EAClB,SAAS;EACT,WAAW;EACX,WAAW;EACX,YAAY;EACZ,UAAU;EACV,6BAA6B;EAC7B,WAAW;AACb;;AAEA;EACE,uBAAuB;AACzB;;AAEA;EACE,UAAU;AACZ","sourcesContent":[".imagePreview {\n  position: relative;\n  height: 36px;\n  width: 40px;\n  border-radius: 6px;\n  overflow: hidden;\n  cursor: pointer;\n  border: 1px solid var(--border);\n}\n\n.imagePreview img {\n  width: 100%;\n  height: 100%;\n  object-fit: cover;\n  display: block;\n}\n\n.removeButton {\n  position: absolute;\n  top: -6px;\n  right: -6px;\n  width: 16px;\n  height: 16px;\n  opacity: 0;\n  transition: opacity 0.2s ease;\n  z-index: 10;\n}\n\n.removeButton:hover {\n  background: transparent;\n}\n\n.imagePreview:hover .removeButton {\n  opacity: 1;\n}\n"],"sourceRoot":""}]);
// Exports
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("713310575b46e83a9662")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.609994c565d714a02bc2.hot-update.js.map