...
* {
  ...
  border: none;
}`, "",{"version":3,"sources":["webpack://./src/renderer/styles/globals.css"],"names":[],"mappings":"AAAA,WAAW;AACX;EACE,qBAAqB;EACrB,kCAAkC;EAClC,qBAAqB;EACrB,kBAAkB;EAClB,6BAA6B;EAC7B,oBAAoB;EACpB,sBAAsB;EACtB,iBAAiB;EACjB,eAAe;EACf,gBAAgB;AAClB;;AAEA;EACE;IACE,qBAAqB;IACrB,wCAAwC;IACxC,qBAAqB;IACrB,kBAAkB;IAClB,oBAAoB;IACpB,sBAAsB;IACtB,gBAAgB;IAChB,iBAAiB;IACjB,eAAe;EACjB;AACF;;AAEA,eAAe;AACf;EACE,oLAAoL;EACpL,0BAA0B;EAC1B,yBAAyB;EACzB,2BAA2B;EAC3B,uBAAuB;AACzB;;AAEA,SAAS;AACT;EACE,eAAe;EACf,+BAA+B;EAC/B,mCAAmC;EACnC,wBAAwB;EACxB,gBAAgB;EAChB,uCAAuC;EACvC,mCAAmC;EACnC,aAAa;EACb,UAAU;AACZ;;AAEA,wBAAwB;AACxB;EACE,SAAS;EACT,UAAU;EACV,sBAAsB;EACtB,YAAY;AACd","sourcesContent":["/* Colors */\n:root {\n  --background: #FBFDEB;\n  --background-tint: rgba(0,0,0,0.1);\n  --foreground: #1C1C18;\n  --primary: #74AC4D;\n  --primary-foreground: #FBFDEB;\n  --secondary: #EBEECB;\n  --destructive: #B11441;\n  --border: #E7E9CF;\n  --ring: #000fe2;\n  --radius: 0.5rem;\n}\n\n@media (prefers-color-scheme: dark) {\n  :root {\n    --background: #000000;\n    --background-tint: rgba(255,255,255,0.1);\n    --foreground: #fafafa;\n    --primary: #74AC4D;\n    --secondary: #222222;\n    --destructive: #B11441;\n    --input: #111111;\n    --border: #27272a;\n    --ring: #000fe2;\n  }\n}\n\n/* Typography */\n:root {\n  --font-family: -apple-system-medium, -apple-system, BlinkMacSystemFont, avenir next, avenir, segoe ui, helvetica neue, helvetica, Cantarell, Ubuntu, roboto, noto, arial, sans-serif;\n  --font-weight-regular: 400;\n  --font-weight-medium: 500;\n  --font-weight-semibold: 600;\n  --font-weight-bold: 700;\n}\n\n/* Body */\nbody {\n  font-size: 16px;\n  font-family: var(--font-family);\n  background-color: var(--background);\n  color: var(--foreground);\n  line-height: 1.2;\n  font-weight: var(--font-weight-regular);\n  -webkit-font-smoothing: antialiased;\n  height: 100vh;\n  padding: 0;\n}\n\n/* Reset & Base Styles */\n* {\n  margin: 0;\n  padding: 0;\n  box-sizing: border-box;\n  border: none;\n}"],"sourceRoot":""}]);
// Exports
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("9e7e3504dcb6c16cb767")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.f54c8913a92d74757eaa.hot-update.js.map