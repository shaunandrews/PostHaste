...
`, "",{"version":3,"sources":["webpack://./src/renderer/components/Editor/Editor.module.css"],"names":[],"mappings":"AAAA;EACE,aAAa;EACb,sBAAsB;EACtB,YAAY;EACZ,aAAa;AACf;;AAEA;EACE,YAAY;EACZ,aAAa;EACb,sBAAsB;EACtB,cAAc;AAChB;;AAEA;EACE,YAAY;EACZ,aAAa;EACb,aAAa;AACf;;AAEA;EACE,+BAA+B;AACjC;;AAEA;;;EAGE,aAAa;EACb,yBAAyB;EACzB,mBAAmB;EACnB,kBAAkB;EAClB,eAAe;EACf,SAAS;AACX;;AAEA;EACE,aAAa;EACb,8BAA8B;EAC9B,mBAAmB;EACnB,aAAa;EACb,mCAAmC;AACrC;;AAEA;EACE,WAAW;EACX,YAAY;EACZ,kBAAkB;EAClB,gBAAgB;EAChB,eAAe;EACf,+BAA+B;EAC/B,6BAA6B;AAC/B;;AAEA;EACE,YAAY;AACd;;AAEA;EACE,WAAW;EACX,YAAY;EACZ,iBAAiB;AACnB","sourcesContent":[".container {\n  display: flex;\n  flex-direction: column;\n  flex-grow: 1;\n  height: 100vh;\n}\n\n.editor {\n  flex-grow: 1;\n  display: flex;\n  flex-direction: column;\n  overflow: auto;\n}\n\n.canvas {\n  flex-grow: 1;\n  padding: 24px;\n  outline: none;\n}\n\n.canvas:empty:before {\n  content: attr(data-placeholder);\n}\n\n.canvas:empty:fo\n\n.tools {\n  display: flex;\n  justify-content: flex-end;\n  align-items: center;\n  padding: 12px 24px;\n  font-size: 14px;\n  gap: 12px;\n}\n\n.actions {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding: 12px;\n  border-top: 1px solid var(--border);\n}\n\n.imagePreview {\n  width: 40px;\n  height: 40px;\n  border-radius: 4px;\n  overflow: hidden;\n  cursor: pointer;\n  border: 1px solid var(--border);\n  transition: opacity 0.2s ease;\n}\n\n.imagePreview:hover {\n  opacity: 0.8;\n}\n\n.imagePreview img {\n  width: 100%;\n  height: 100%;\n  object-fit: cover;\n}\n"],"sourceRoot":""}]);
// Exports
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("b36904c9807f30e81525")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.b6a765c6ee7e992019af.hot-update.js.map