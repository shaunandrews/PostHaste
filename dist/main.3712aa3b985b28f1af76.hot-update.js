...
`, "",{"version":3,"sources":["webpack://./src/renderer/components/Interface/Switch/Switch.module.css"],"names":[],"mappings":"AAAA;EACE,oBAAoB;EACpB,YAAY;EACZ,cAAc;EACd,cAAc;EACd,eAAe;EACf,mBAAmB;EACnB,qBAAqB;EACrB,+BAA+B;EAC/B,oBAAoB;AACtB;;AAEA;EACE,aAAa;EACb,yBAAyB;AAC3B;;AAEA;EACE,mBAAmB;EACnB,YAAY;AACd;;AAEA;EACE,gCAAgC;AAClC;;AAEA;EACE,mCAAmC;AACrC;;AAEA;EACE,oBAAoB;EACpB,cAAc;EACd,YAAY;EACZ,WAAW;EACX,qBAAqB;EACrB,mCAAmC;EACnC,mCAAmC;EACnC,0BAA0B;AAC5B;;AAEA;EACE,2BAA2B;AAC7B;;AAEA;EACE,wBAAwB;AAC1B","sourcesContent":[".root {\n  display: inline-flex;\n  height: 24px;\n  width: 2.25rem;\n  flex-shrink: 0;\n  cursor: pointer;\n  align-items: center;\n  border-radius: 9999px;\n  border: 1px solid var(--border);\n  transition: all 0.2s;\n}\n\n.root:focus-visible {\n  outline: none;\n  border-color: var(--ring);\n}\n\n.root:disabled {\n  cursor: not-allowed;\n  opacity: 0.5;\n}\n\n.root[data-state=\"checked\"] {\n  background-color: var(--primary);\n}\n\n.root[data-state=\"unchecked\"] {\n  background-color: var(--background);\n}\n\n.thumb {\n  pointer-events: none;\n  display: block;\n  height: 1rem;\n  width: 1rem;\n  border-radius: 9999px;\n  background-color: var(--background);\n  box-shadow: 0 1px 2px var(--border);\n  transition: transform 0.2s;\n}\n\n.thumb[data-state=\"checked\"] {\n  transform: translateX(1rem);\n}\n\n.thumb[data-state=\"unchecked\"] {\n  transform: translateX(0);\n}\n"],"sourceRoot":""}]);
// Exports
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("ac2f115737d205eebdca")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.3712aa3b985b28f1af76.hot-update.js.map